...
const contextualResponse=(answer,situation,lensIndex,round,choiceIndex)=>{
 ...
 const endings=[
  [phase+", I would say that "+situation+" has unsettled me and ask what changed.",phase+", I would give myself space to see how "+situation+" feels before I decide whether to say more.",phase+", I would look for a clear next step that makes "+situation+" less uncertain."],
  [phase+", I would keep returning to whether "+situation+" needs an honest conversation.",phase+", I would keep replaying "+situation+" privately until I feel ready to say more.",phase+", I would keep noticing whether "+situation+" is a one-off or part of a larger pattern."],
  [phase+", I would feel steadier if I could speak openly about "+situation+".",phase+", I would feel steadier if I could take time away from "+situation+" before I respond.",phase+", I would feel steadier if there were a practical agreement around "+situation+"."]
 ];
